        ...
        <div class="row justify-content-center">
            <div class="col-12 col-sm-9 col-md-7 col-lg-6 col-xl-5"><img class="big-logo"
                ...
                <div class="register-form mt-5 px-4">
                    <form action="{{ url('register')  }}" method="post">
                        ...
                        <div class="form-group text-left mb-4"><span>Full Name</span>
                            ...
                            <input class="form-control" id="username" type="text" name="fullName"
                        ...
                        <div class="form-group text-left mb-4"><span>Password</span>
                            ...
                            <input class="input-psswd form-control" id="registerPassword" name="password"
                                   type="password"
                                   placeholder="********************">
                        </div>
                        <div class="form-group text-left mb-4"><span>Role</span>
                            <label for="role"><i class="lni lni-user"></i></label>
                ...
                <div class="login-meta-data">
                    <p class="mt-3 mb-0">Already have an account?<a class="ml-1" href="{{ url('login') }}">Sign In</a>
                    </p>
                </div>
