...
<div class="header-area" id="headerArea">
    <div class="container h-100 d-flex align-items-center justify-content-between">
        ...
        <div class="page-heading">
            <h6 class="mb-0">MY <span style="color: #00b894">TRASH</span> (BUYER)</h6>
        </div>
        <div class="filter" id="">
    ...
    <div class="container h-100 px-0">
        <div class="suha-footer-nav h-100">
            <ul class="h-100 d-flex align-items-center justify-content-between pl-0">
                <li><a href="{{ url('buyer') }}"><i class="lni lni-home"></i>Home</a></li>
                <li><a href="{{ url('buyer/history') }}"><i class="lni lni-shopping-basket"></i>History</a></li>
                <li><a href="{{ url('buyer/help') }}"><i class="lni lni-help"></i>Help</a></li>
                <li><a href="{{ url('buyer/profile') }}"><i class="lni lni-user"></i>Account</a></li>
