                ...
                <div class="row g-3">
                    ...
                    <div class="col-4">
                        <div class="card catagory-card">
                            <div class="card-body"><a href="{{ url('trash-pick') }}"><i class="lni lni-trash"></i><span>Trash Pick</span></a>
                            </div>
                        </div>
                    </div>
                    <!-- Single Catagory Card-->
                    <div class="col-4">
                        <div class="card catagory-card">
                            <div class="card-body"><a href="{{ url('point') }}"><i
                                        class="lni lni-coin"></i><span>Trash Point</span></a></div>
                        </div>
                    </div>
                    <!-- Single Catagory Card-->
                    <div class="col-4">
    ...
    <div class="cta-area">
        <div class="container">
            <div class="cta-text p-4 p-lg-5">
                <h4>Hi, <b>{{ session('seller')['name']  }}</b></h4>
                <p>Your Point : {{ $result[0]->point }}</p>
            </div>
        </div>
    </div>
